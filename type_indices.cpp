...
static match do_not_use_this_match{do_not_use_this_session, do_not_use_this_production, 0, do_not_use_this_token_sequence.end(), do_not_use_this_token_sequence.end()};
